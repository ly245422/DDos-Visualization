...
def Attack(totalAttackRequests, serverNum, servers):
    ...
    # requests = [0, 50, 250, 500, 750, 1000]
    # requests_per_server = [0, 50, 250, 500, 750, 1000]
    # requests_per_server = [0] * (num_servers + cloudNum)
    # # 将请求随机分配给服务器
    # for i in range(total_requests):
    #     # 选择一个随机的服务器索引
    #     server_index = random.randint(0, num_servers + cloudNum - 1)
    #     # 增加所选服务器的请求数量
